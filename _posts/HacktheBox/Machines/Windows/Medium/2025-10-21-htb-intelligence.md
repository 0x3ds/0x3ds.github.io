...
tags: [htb-blue, blue, hackthebox, machine, ctf, windows, easy, nmap, crackmapexec, smbmap, smbclient, smb, dns, dnsenum, ldapsearch, exiftool, gobuster, kerbrute, python, password-spray, bloodhound, bloodhound-python, dnstool, responder, hashcat, readgmsapassword, gmsa, gmsadumper, silver-ticket, wmiexec]
image:
